function [ aa bb cc ] = unforwardflight( Vf0, Vf1 )
% FORWARDFLIGHT
...
for mm1 =1: 1: 2;
    for mm2 = 1: 1: 2;
        for i = 1: 1: LengM
            ...
            ThrustReqX( i, : ) = DragParasi( i, : ) + DragParasi2( i, : ) .* sin( theta( i, : ) );
            ...
            ProMethod = 1;
            if ProMethod == 1
                infloVf( i, : ) =  Vf .* sin( theta( i, : ) );
                deltaVf( i, : ) = V1f( i, : ) +  infloVf( i, : );
        ...
        figure(5)
        subplot( 2, 2, qqq );
        kk =  plot( Vf, ThrustReqF( CounterGeh, : ), ...
            Vf, ThrustReqY( CounterGeh, : ), '--g',...
            Vf, ThrustReqX( CounterGeh, : ), '-.r');
        set( kk, 'linewidth', 2.00 );
        ...
        figure(6)
        subplot( 2, 2, qqq );
        kq =  plot( Vf, deltaVf( CounterGeh, : ), ...
            Vf, V1f( CounterGeh, : ), '--g', ...
            Vf, infloVf( CounterGeh, : ), '--r' );
        set( kq, 'linewidth', 2.0 );
        xlabel( ' Forwrad Speed (m/s) ' );
        ylabel( ' dVf (m/s) ' );
        axis( [ Vf0 Vf1 0 10 ] );
        grid on
        ...
        figure(4)
        subplot( 2, 2, qqq );
        k2 =  plot( Vf, PowerPro( CounterGeh, : ) );
        set( k2, 'linewidth', 2.00 );
        xlabel( ' Forwrad Speed (m/s) ' );
        ylabel( ' Thrust Required (N) ' );
        axis( [ Vf0 Vf1 0 220 ] )
        qqq = qqq + 1;
...
aa = PowerPro( CounterGeh, : );
bb = ThrustReqF( CounterGeh, :);
cc = Vf;
